              ...
              Row(
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text("Card Management", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.black)),
                      Text("You can manage your child's card here.", style: TextStyle(fontSize: 12, color: Colors.grey[600])),
                    ],
                  )
                ],
              ),
                  ...
                  child: Column(
                    ...
                    children: [
                                ...
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: GestureDetector(
                                      onTap: () => controller.showEditChildSheet(context, child),
                                      child: Container(
                      ...
                      Row(
                        ...
                        children: [
                          ElevatedButton.icon(
                            onPressed: () => controller.showTransactionSheet(context, isTopUp: true),
                          ...
                          ElevatedButton.icon(
                            onPressed: () => controller.showTransactionSheet(context, isTopUp: false),
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 14,
                                fontWeight: controller.selectedTab.value == 0 ? FontWeight.bold : FontWeight.w500,
                                color: controller.selectedTab.value == 0 ? Colors.black87 : Colors.grey[500],
                              ),
                            ),
                          ),
                          const SizedBox(width: 16),
                          GestureDetector(
                            ...
                            child: Text (
                              ...
                              style: TextStyle(
                                fontSize: 14,
                                fontWeight: controller.selectedTab.value == 1 ? FontWeight.bold : FontWeight.w500,
                                color: controller.selectedTab.value == 1 ? Colors.black87 : Colors.grey[500],
                              ),
                            ),
                          ),
                        ],
                        ...
                        child: Container(
                          ...
                          child: Obx(() {
                            if (controller.selectedTab.value == 0) {
                              return _RecentTransactionsTab(controller: controller);
                            } else {
...
class _TransactionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final kind = _kind;
    final formattedDate = DateFormat('dd MMM, hh:mm a').format(transaction.createdAt);
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final maxValue = days.fold<double>(0.0, (max, day) {
        final total = (day['spend'] as double) + (day['topUp'] as double) + (day['withdraw'] as double);
            ...
            SizedBox(
              ...
              child: Row(
                ...
                children: days.map((day) {
                  ...
                  final barHeight = maxValue > 0 ? (total / maxValue) * 100 : 0.0;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: isToday ? const Color(0xFF2B2B2B) : Colors.grey[350],
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              color: isToday ? Colors.black87 : Colors.grey[500],
                            ),
                          ),
                        ],
                      ),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Wrap(
                        ...
                        children: [
                          if (spend > 0)
                            Text('Spent RM ${spend.toStringAsFixed(2)}', style: TextStyle(fontSize: 11, color: Colors.grey[700])),
                          if (topUp > 0)
                            Text('+RM ${topUp.toStringAsFixed(2)}', style: const TextStyle(fontSize: 11, color: Color(0xFF2E7D32))),
                          if (withdraw > 0)
                            Text('-RM ${withdraw.toStringAsFixed(2)}', style: const TextStyle(fontSize: 11, color: Color(0xFFB45309))),
                        ],
                      ),
                    ),
                  ],
